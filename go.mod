...
require (
	github.com/Switcheo/polynetwork-cosmos v0.0.0-20240319084029-ea2a00c1aa28
...
replace (
	...
	github.com/polynetwork/poly => github.com/Switcheo/poly v0.0.0-20240319084919-9e98bbfba72f
)
